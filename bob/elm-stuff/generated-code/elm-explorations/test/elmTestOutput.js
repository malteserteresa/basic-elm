...
var author$project$Bob$isQuestion = function (remark) {
	return A2(elm$core$String$endsWith, '?', remark) ? true : false;
};
var elm$core$String$any = _String_any;
var elm$core$String$filter = _String_filter;
var author$project$Bob$isUpperCase = function (remark) {
	return A2(
		elm$core$String$all,
		elm$core$Char$isUpper,
		A2(elm$core$String$filter, elm$core$Char$isAlpha, remark)) && A2(elm$core$String$any, elm$core$Char$isAlpha, remark);
};
var elm$core$String$trim = _String_trim;
var author$project$Bob$hey = function (remark) {
	var trimmed = elm$core$String$trim(remark);
	return (author$project$Bob$isQuestion(trimmed) && author$project$Bob$isUpperCase(trimmed)) ? 'Calm down, I know what I\'m doing!' : (author$project$Bob$isQuestion(trimmed) ? 'Sure.' : ((trimmed === '') ? 'Fine. Be that way!' : (author$project$Bob$isUpperCase(trimmed) ? 'Whoa, chill out!' : 'Whatever.')));
};
...
var author$project$Test$Generated$Main3092020291$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/tcake/exercism/elm/bob/tests/Tests.elm']),
		processes: 4,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 399050582968671
	},
...
_Platform_export({'Test':{'Generated':{'Main3092020291':{'init':author$project$Test$Generated$Main3092020291$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-5271.sock";
